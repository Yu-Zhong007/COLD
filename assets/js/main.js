...
document.addEventListener("DOMContentLoaded", function () {
    ...
    window.addEventListener('scroll', function() {
        ...
        if (rect.top <= window.innerHeight) {
            colorShiftElement.style.backgroundColor = '#ffffff';
        } else {
            colorShiftElement.style.backgroundColor = '#c0e2fb';
        }
    });
...
const episodes = [
    { id: 'epPlaceholder1', title: 'ep. 1', background: 'assets/img/episode-1.jpg', video: 'assets/video/episode-1.mp4' },
    { id: 'epPlaceholder2', title: 'ep. 2', background: 'assets/img/episode-2.jpg', video: 'assets/video/episode-2.mp4' },
    { id: 'epPlaceholder3', title: 'ep. 3', background: 'assets/img/episode-3.jpg', video: 'assets/video/episode-3.mp4' },
    { id: 'epPlaceholder4', title: 'ep. 4', background: 'assets/img/episode-4.jpg', video: 'assets/video/episode-4.mp4' },
    { id: 'epPlaceholder5', title: 'ep. 5', background: 'assets/img/episode-5.jpg', video: 'assets/video/episode-5.mp4' },
    { id: 'epPlaceholder6', title: 'ep. 6', background: 'assets/img/episode-6.jpg', video: 'assets/video/episode-6.mp4' }
];
